...
import LOGOS_00_00_objects as stfs
...
class NeuralNetwork_MAIN():
    ...
    def NeuralNetwork(sf, I_grp, prop, filename):
        ...
        for epoch in range(n_epochs):
            ...
            # Acuracy Evaluation at The end of each epoch
        ...
        # Restore Model And Return Accuracy
...
if __name__ == "__main__":
    ...
    Yprop = open('LOGOS-NN-Prop_04_ag1_Training-Set.csv')
    Yprop = Yprop.read()
    Yprop = Yprop.split()
    ...
    PercentSplit = 0.7
    filename = 'BestWeights_04_alpha.pth.tar'
    ...
    print('Weights are Stored in : BestWeights_04_alpha.pth.tar')
